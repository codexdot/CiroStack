...
export default function Navigation({ isDarkMode, toggleDarkMode, scrollToSection }: NavigationProps) {
  ...
  return (
    <nav className="fixed w-full z-50 bg-[#020617]/90 backdrop-blur-md border-b border-slate-800">
        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex space-x-8">
            ...
            <div className="flex items-center ml-4">
              <span className="mr-2 text-sm text-slate-400">Dark</span>
      ...
      {/* Mobile menu */}
      <div className={`mobile-menu ${isMobileMenuOpen ? 'block' : 'hidden'} md:hidden bg-[#020617] border-t border-slate-800`}>
